...
export class StatusService {
  ...
  searchStatus(id: string): Observable<Status[]> {
    return this.http
      .post<Status[]>(`${this.apiUrl}/searchClient`, { id }, this.httpOptions)
      .pipe(catchError(this.handleError<Status[]>('searchClient', [])));
  }

  // Update an existing Client
  updateStatus(client: Status): Observable<Status> {
    return this.http
      .put<Status>(`${this.apiUrl}`, client, this.httpOptions)
      .pipe(catchError(this.handleError<Status>('updateClient')));
  }
  ...
  createStatus(status: Status): Observable<Status> {
    return this.http
      .post<Status>(this.apiUrl, status, this.httpOptions)
      .pipe(catchError(this.handleError<Status>('createStatus')));
  }
  ...
  getAllStatuses(): Observable<Status[]> {
    return this.http
      ...
      .pipe(catchError(this.handleError<Status[]>('getAllStatuses', [])));
  }
