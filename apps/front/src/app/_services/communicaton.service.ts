...
// import { COMMUNICATIONS } from '../api-urls';
...
//     return this.http
//       .post<Communication[]>(`${this.apiUrl}/all`, {})
//       .pipe(
//         catchError(
//           this.handleError<Communication[]>('getAllCommunications', [])
//         )
//       );
//   }
...
//     return this.http
//       .post<Communication[]>(
//         `${this.apiUrl}/by-client`,
//         { clientId },
//         this.httpOptions
//       )
//       .pipe(
//         catchError(
//           this.handleError<Communication[]>('getCommunicationsByClientId', [])
//         )
//       );
//   }
...
//         this.httpOptions
//       )
//       .pipe(catchError(this.handleError<Communication>('updateCommunication')));
//   }

//   deleteCommunication(id: string): Observable<void> {
//     return this.http
//       .post<void>(`${this.apiUrl}/delete`, { id }, this.httpOptions)
//       .pipe(catchError(this.handleError<void>('deleteCommunication')));
//   }
