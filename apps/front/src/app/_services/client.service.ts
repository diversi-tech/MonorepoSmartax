...
export class ClientService {
  ...
  createClient(client: Client): Observable<Client> {
    return this.http
      .post<Client>(this.apiUrl, client, this.httpOptions)
      .pipe(catchError(this.handleError<Client>('createClient')));
  }
  ...
  updateClient(client: Client): Observable<Client> {
    return this.http
      .put<Client>(`${this.apiUrl}`, client, this.httpOptions)
      .pipe(catchError(this.handleError<Client>('updateClient')));
  }
  fetchSensitiveDataForClient(
    clientId: string
  ): Observable<CreateSensitiveDataDto[]> {
