...
//add
  ...
  controllers: [AppController,ClientTypeController, UserController, ClientController, TasksController, CommunicationsController, BillingController,MailController, GoogleDriveController, AuthController,RoleController],  
  providers: [
    AppService,
    // DbService,
