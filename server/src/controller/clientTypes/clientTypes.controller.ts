...
export class ClientTypeController {
  ...
  async createClientType(
    @Body(new ValidationPipe()) createClientTypeDto: CreateClientTypeDto
  ): Promise<ClientType> {
  ...
  async updateClientType(
    @Body(new ValidationPipe()) updateClientTypeDto: UpdateClientTypeDto
  ): Promise<ClientType> {
  ...
  async deleteClientType(
    @Body(new ValidationPipe()) id: { id: string }
  ): Promise<boolean> {
