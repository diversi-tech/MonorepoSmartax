...
export class CommunicationsController {
  ...
  async create(
    ...
    return this.communicationsService.createCommunication(
      createCommunicationDto
    );
  }
  ...
  async update(
    ...
    return this.communicationsService.updateCommunication(
      id,
      updateCommunicationDto
    );
  }
  ...
  async getCommunicationsByClientId(
    ...
    return this.communicationsService.getCommunicationsByClientId(
      body.clientId
    );
  }
  @UseGuards(AuthGuard, RoleGuard(3))
  ...
  @ApiOperation({
    summary:
      'Delete old comunication and moved them to the communicationArchives table',
  })
